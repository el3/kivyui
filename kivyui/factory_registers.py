...
register("UButton", module="kivyui.widgets.button")
register("UTextInput", module="kivyui.widgets.textinput")
register("UDropDown", module="kivyui.widgets.dropdown")
register("DatePicker", module="kivyui.widgets.datepicker")
