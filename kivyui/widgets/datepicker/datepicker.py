...
from kivyui.widgets.button import UButton
...
class Day(BoxLayout):
    ...
    def select_date(self, day_button: Widget) -> None:
...
class Month(BoxLayout):
    ...
    def __init__(self, timestamp: float, **kwargs):
        super().__init__(**kwargs)
        Clock.schedule_once(partial(self.set_month, timestamp))

    def set_month(self, timestamp: float, dt=0) -> None:
